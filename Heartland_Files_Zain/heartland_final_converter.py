...
if __name__ == '__main__':
    file_to_upload = 'input_files\\Heartland Template.xlsx'
    ...
    groups_df = fun_groups_sheet_handler(file_to_upload)
    modifier_df = fun_modifiers_sheet_handler(file_to_upload)
    options_df = fun_ingredients_sheet_handler(file_to_upload)

    item_modifier_mapping_df = fun_item_modifier_mapping(file_to_upload, file_to_upload)

    modifier_item_df2 = create_modifier_item_mapping(file_to_upload, file_to_upload)

    category_menu_df = fun_category_menu_mapping()

    item_category_df = fun_item_category_mapping(file_to_upload, file_to_upload)
